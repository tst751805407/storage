...
<link href="/Storage/Public/BJUI/themes/css/bootstrap.min.css" rel="stylesheet">
<style type="text/css">
* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
body {
    background: url(/Storage/Public/images/loginbg/loginbg_01.jpg) no-repeat center center fixed;
...
function choose_bg() {
	...
	$('body').css('background-image', 'url(/Storage/Public/images/loginbg/loginbg_0'+ bg +'.jpg)');
}
</script>
</head>
<body>
<div class="main_box">
	...
	<div class="login_box">
        <div class="login_logo">
            <img src="/Storage/Public/images/logo.png" >
        </div>
        <!--
	...
	<div class="bottom">杭州师范大学 &nbsp;仓库管理系统毕设设计</div>
</div>
</body>
</html>