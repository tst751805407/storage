...
<form id="pagerForm" data-toggle="ajaxsearch" action="/Storage/index.php?s=/Home/User" method="post">
        ...
        <div class="bjui-searchBar">
			...
			<option value="">全部</option>
             ...
             <button type="submit"  class="btn-default" data-icon="search">查询</button>
			  ...
			  <?php if(display(CONTROLLER_NAME.'/del')){ ?><span style="float:right;" ><a href="/Storage/index.php?s=/Home/User/del/navTabId/<?php echo CONTROLLER_NAME;?>" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要清理吗？" data-icon="remove">清理</a></span><?php } ?>
			  <?php if(display(CONTROLLER_NAME.'/add')){ ?><span style="float:right;margin-right:5px;"><a href="/Storage/index.php?s=/Home/User/add/navTabId/<?php echo CONTROLLER_NAME;?>" class="btn btn-green" data-toggle="dialog" data-width="600" data-height="450" data-id="dialog-mask" data-mask="true" data-icon="plus">新增</a></span><?php } ?>
		</div> 
</form>
     ...
     <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
        ...
        <tbody>
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
		   ...
		   <?php if(display(CONTROLLER_NAME.'/lock')){ ?><td><a href="/Storage/index.php?s=/Home/User/lock/id/<?php echo ($v['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>" data-toggle="doajax" data-confirm-msg="确定要操作吗？"><?php if($v["status"] == 1 ): ?><img src="/Storage/Public/images/ok.gif" border="0"/><?php else: ?><img src="/Storage/Public/images/locked.gif" border="0"/><?php endif; ?></a></td><?php } ?>
		   <?php if(display(CONTROLLER_NAME.'/edit')){ ?><td> <a href="/Storage/index.php?s=/Home/User/edit/id/<?php echo ($v['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>"   class="btn btn-green btn-sm" data-toggle="dialog" data-width="600" data-height="450" data-id="dialog-mask" data-mask="true" >编辑</a></td><?php } ?>
