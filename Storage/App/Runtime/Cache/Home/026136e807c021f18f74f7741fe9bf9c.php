...
<form id="pagerForm" data-toggle="ajaxsearch" action="/Storage/index.php?s=/Home/Ruku" method="post">
        ...
        <div class="bjui-searchBar">
            <label>关键词：</label><input type="text" value="<?php echo ($_REQUEST['keys']); ?>" name="keys" class="form-control" size="12" />
             ...
             <button type="submit"  class="btn-default" data-icon="search">查询</button>
			  ...
			  <?php if(display(CONTROLLER_NAME.'/add')){ ?><span style="float:right;margin-right:5px;"><a href="/Storage/index.php?s=/Home/Ruku/add/navTabId/<?php echo CONTROLLER_NAME;?>" class="btn btn-green" data-toggle="dialog" data-width="900" data-height="500" data-id="dialog-mask" data-mask="true" data-icon="plus">新增</a></span><?php } ?>
		</div> 
</form>
...
<div class="btn btn-green btn-sm"  ><?php echo ($v["shenhe"]); ?></div>
</td><?php } ?>
<td><?php echo (msubstr($v["uname"],0,20)); ?></td>
<td><?php echo (substr($v["addtime"],0,10)); ?></td>

		   <?php if(display(CONTROLLER_NAME.'/edit')){ ?><td><a href="/Storage/index.php?s=/Home/Ruku/edit/id/<?php echo ($v['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>"   class="btn btn-green btn-sm" data-toggle="dialog" data-width="900" data-height="500" data-id="dialog-mask" data-mask="true" >编辑</a>
		   </if></td><?php } ?>
		   </td>
